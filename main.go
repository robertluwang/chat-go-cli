...
func printUsage() {
	fmt.Println("Usage: chat_cli [options] [prompt]")
	...
	fmt.Println("\nExamples:")
	fmt.Println("  ./chat_cli")
	fmt.Println("  ./chat_cli --model gemini-pro \"What is the weather like today?\"")
	fmt.Println("  ./chat_cli Explain quantum computing in one sentence")
}
